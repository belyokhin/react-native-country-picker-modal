...
export const CountryPicker = (props) => {
  ...
  return (React.createElement(React.Fragment, null,
    ...
    React.createElement(CountryModal, Object.assign({}, {
        visible,
        withModal,
        disableNativeModal, ...modalProps,
